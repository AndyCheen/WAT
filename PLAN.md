...
| **10** | Відчуття та відгук | ✅ | гаптика з вимикачем, стани натискання, анімовані шторки + drag-to-dismiss, пульс кільця при виконанні норми, тост із «Скасувати», пояснення стелі 120 %, Reduce Motion |
...
5. **Шар відгуку був відсутній як клас.** Грепом по всьому дереву: нуль `sensoryFeedback`,
...
6. **Норма й новий рівень закриваються тією самою порцією.** Перша версія показувала щось
   одне, і святкування виконаної норми губилося за тостом про рівень. Тепер це різні канали:
   святкування ← `goalJustReached`, тост ← підвищення рівня, вібрація ← найпомітніша з подій.
