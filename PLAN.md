...
блок на 3f зливається з «НАГОРОДА НА РІВНІ N», однакові призи складаються в стос «×N»;
новий екран «Призи» (Мої · Історія); дія — лише в картці призу. Детально — **`SPEC-PRIZES.md`**,
макет — `Design/Prizes.html`.
