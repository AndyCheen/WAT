...
### 7.3a Модуль «Призи» (WAT-26)

Поточний блок «ПРИЗИ» працює лише формально: 3 з 5 призів після «Активувати» нічого не роблять,
...
**Тести:** 151 unit (8 пакетів) + 14 e2e у симуляторі — усі зелені.
...
8. **Призи** за `SPEC-PRIZES.md` (WAT-26): заморозка серії зараз не витрачається взагалі —
   це найсуттєвіша прогалина гейміфікації.
